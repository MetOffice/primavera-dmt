...
## Raise Issues:  
Report bugs and request enhancements by raising an issue in the `primavera-dmt` issues section.
If reporting an issue, try to include information on how to reproduce the bug/error.

## Contribute Code
All contributions to `primavera-dmt` are made via merges with the master branch.  
 ...
 * If I become aware of anything that would make any of the above inaccurate, in any way, I will let the UK Met Office know as
 ...
 (The `primavera-dmt` Contributor Licence Agreement and Certificate of Origin is inspired by the Certificate of Origin
